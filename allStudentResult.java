...
public class allStudentResult extends javax.swing.JFrame {
    ...
    public allStudentResult() {
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("SELECT rollNo,CONCAT(fname,' ',lname) as Name,total from student s inner join company_student c on s.rollNo=c.student_id \n" +
                                         "order by total desc");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 116, -1, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 113, 190, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 162, 969, 330));
