...
public String rollNo;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Start Your Interview");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 690, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/instructionbg.png"))); // NOI18N
...
//           ResultSet rs2=st.executeQuery("select count(id) from company_student");
//           rs2.first();
//           int id=rs2.getInt(1);
